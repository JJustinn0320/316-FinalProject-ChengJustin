...
function AuthContextProvider(props) {
    ...
    auth.registerUser = async function(username, email, avatar, password, passwordConfirm) {
        console.log("REGISTERING USER");
        try{   
            const response = await authRequestSender.registerUser(username, email, avatar, password, passwordConfirm);   
            if (response.status === 200) {
